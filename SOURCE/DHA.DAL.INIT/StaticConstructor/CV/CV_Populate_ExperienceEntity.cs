...
namespace DHA.DAL.INIT.StaticConstructor.CV
{
    ...
    {           
        ...
        private static int Init_Experience_Servantes_DUT(MyDb pMyDb)
        {
            ...
            int lIntActivityId =
                pMyDb.CVFeedCR.add_activity(lIntExperienceID, S_Int_JobID_StaigiaireDevASP,
                "ELECTRE", "Réalisation d’un site intranet de gestion des congés Payés.", "",
                    "Apprentissage de l'ASP.");
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "SQLS", "W2000", "ASP");
        ...
        private static void Init_Experience_MIAGE(MyDb pMyDb)
        {
            ...
            int lIntExperienceID =
               ...
               "Licence et Maîtrise MIAGE en alternance, Faculté d'Evry",
                ...
                2003, 10);
            int lIntActivityId =
                pMyDb.CVFeedCR.add_activity(lIntExperienceID, S_Int_JobID_DevAlternant,
                ...
                "Réalisation de la charte graphique.");
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "SQLS", "W2000", "ASP.NET", "C#");
            lIntActivityId =
                pMyDb.CVFeedCR.add_activity(lIntExperienceID, S_Int_JobID_DevAlternant,
                "ITALCEMENTI", "Réalisation d'un trombinoscope",
                "", "Développement du module d'administration.");
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "SQLS", "W2000", "VBNET", "ASP.NET");
            lIntActivityId =
                pMyDb.CVFeedCR.add_activity(lIntExperienceID, S_Int_JobID_DevAlternant,
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "SQLS", "W2000", "ASP", "VB");
            ...
            lIntActivityId =
                ...
                "Maintenance corrective et évolutive");
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "SQLS", "W2000", "ACCESS", "VB");
        ...
        private static void Init_Experience_W4(MyDb pMyDb)
        {
            ...
            int lIntActivityId =
                pMyDb.CVFeedCR.add_activity(lIntExperienceID, S_Int_JobID_DevStagiaire,
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "W2000", "C#", "ASP.NET", "JAVA", "XML", "JUNIT", "ECLIPSE");
        ...
        private static void Init_Experience_SCPP(MyDb pMyDb)
        {
            ...
            int lIntActivityId =
                pMyDb.CVFeedCR.add_activity(lIntExperienceID, S_Int_JobID_DevExpertTechPresta,
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "C#", "ASP.NET", "ORACLE", "WEBSERVICE");
        ...
        private static void Init_Experience_ORDRE_AVOCATS(MyDb pMyDb)
        {
            ...
            int lIntActivityId =
                pMyDb.CVFeedCR.add_activity(lIntExperienceID, S_Int_JobID_DevAnalystePresta,
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "W2000", "DOTNET", "C#", "ORACLE", "WEBSERVICE", "CR9", "VSS", "WINFORM");
        ...
        private static void Init_Experience_BNPP(MyDb pMyDb)
        {
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "WXP", "DOTNET", "C#", "ORACLE", "WEBSERVICE", "CR9");
        ...
        private static void Init_Experience_MEDIAMOBILE(MyDb pMyDb)
        {
            ...
            int lIntActivityId =
               pMyDb.CVFeedCR.add_activity(lIntExperienceID, S_Int_JobID_Expert_Technique_Interne,
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "WXP", "DOTNET", "C#", "ORACLE", "SERVICESDOTNET");
        ...
        private static void Init_Experience_MAYOLY_SPINDLER(MyDb pMyDb)
        {
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "DAX", "SQLS");
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "SSIS", "OLAP", "ACCESS", "SSRS", "SQLS");
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "SQLS", "DOTNET");
        ...
        private static void Init_Experience_HUMANIS_DGCD(MyDb pMyDb)
        {
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "C#", "DOTNET", "TFS", "ASP.NET", "SQLS");
        ...
        private static void Init_Experience_METSO(MyDb pMyDb)
        {
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "C#", "DOTNET", "WINFORM", "SQLS", "SERVICESDOTNET");
        ...
        private static void Init_Experience_HUMANIS_AGD(MyDb pMyDb)
        {
            ...
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "C#", "DOTNET", "TFS", "ASP.NET", "SQLS", "SSIS", "GIT");
        ...
        private static void Init_Experience_AGAP2(MyDb pMyDb)
        {
            ...
            int lIntActivityId =
               ...
               "Développement .Net",
               "Maintenance Azure");
            pMyDb.CVFeedCR.add_skills(lIntActivityId, "C#", "DOTNET", "AZURE", "ASP.NET", "SQLS", "SSIS", "GIT");

        }//Init_Experience_AGAP2

        static CV_Firm Get_Firm(MyDb pMyDb, string pStrFirmKey)
        {
            CV_Firm? lFirm = pMyDb.CVFirmRepository.FindOne(a => a.Key == pStrFirmKey);
